...
public final class HtmlRenderer {
  ...
  private static final String[] STATIC_ASSETS = {
    ...
    "icon-log.png", "ceiling_android.png", "arrows.png", "bullets.png", "loading.gif","tiny.css"
  };
  ...
  private void generateCssFromLess() {
    try {
      ...
      String less = Resources.toString(getClass().getResource("/static/spoon.css"), UTF_8);
